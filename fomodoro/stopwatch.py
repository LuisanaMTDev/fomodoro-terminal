...
from fomodoro.utils import States, INFO_FILE, TIME_FORMAT
...
def run_stopwatch(stopwatch: Stopwatch):
    ...
    while stopwatch.state is States.START:
        ...
        stopwatch.seconds += 1
        struct_time_stopwatch = gmtime(float(stopwatch.elapsed_seconds))
        ...
        try:
            ...
            if stopwatch_character == "p":
                ...
                info["elapsed_seconds"] = info["elapsed_seconds"] + stopwatch.seconds
